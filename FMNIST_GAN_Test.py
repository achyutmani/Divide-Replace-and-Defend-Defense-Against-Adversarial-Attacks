...
batch_size = 4096*2
data_loader = torch.utils.data.DataLoader(FashionMNIST('FMNIST_Dataset', train=True, download=True, transform=transform),
...
def generate_digit(generator, digit):
    ...
    return img 
Create_Label= 0 
M=generate_digit(generator, Create_Label)  
